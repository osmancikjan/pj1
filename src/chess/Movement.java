...
public class Movement {
    ...
    ArrayList<ModelObject> objectsForMovement = new ArrayList<ModelObject>();
    ...
    public synchronized boolean MoveThatFigure(Figures.Color color, Figures.Type typ, Point pozice, Point direction, ArrayList<ModelObject> objekty) {
        // objectsForMovement = new ArrayList<ModelObject>(objekty.size());
    ...
    private boolean CanTake(Point direction, Figures.Color color) {
        for (ModelObject obj : objectsForMovement) {
            if (obj.getPosition() == direction) {
                if (((Figures) obj).getColor() == color) {
                    return true;
                }
            }
        }
